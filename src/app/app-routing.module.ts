...
const routes: Routes = [
  ...
  {
    path: 'infinityscroll',
    loadChildren: () => import('./pages/infinityscroll/infinityscroll.module').then( m => m.InfinityscrollPageModule)
  },
  {
    path: 'list',
  ...
  {
    path: 'ionselect',
    loadChildren: () => import('./pages/ionselect/ionselect.module').then( m => m.IonselectPageModule)
  },
  {
    path: 'toogle',
